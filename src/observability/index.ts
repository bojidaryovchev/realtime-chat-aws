...
export function createObservability(
  ...
  if (config.realtimeScaleOnConnections) {
    ...
    realtimeHighConnectionsAlarm = new aws.cloudwatch.MetricAlarm(
      `${baseName}-realtime-high-connections`,
      {
    ...
    realtimeHighEventLoopLagAlarm = new aws.cloudwatch.MetricAlarm(
      `${baseName}-realtime-high-eventloop`,
      {
  ...
  if (config.enableRedisSplit && redisOutputs.redisAdapterCluster && redisOutputs.redisStateCluster) {
    ...
    redisAdapterHighCpuAlarm = new aws.cloudwatch.MetricAlarm(
      `${baseName}-redis-adapter-high-cpu`,
      {
    ...
    redisStateHighCpuAlarm = new aws.cloudwatch.MetricAlarm(
      `${baseName}-redis-state-high-cpu`,
      {
    ...
    redisAdapterHighConnectionsAlarm = new aws.cloudwatch.MetricAlarm(
      `${baseName}-redis-adapter-high-connections`,
      {
    ...
    redisStateHighConnectionsAlarm = new aws.cloudwatch.MetricAlarm(
      `${baseName}-redis-state-high-connections`,
      {
  ...
  const rdsHighConnectionsAlarm = new aws.cloudwatch.MetricAlarm(
    `${baseName}-rds-high-connections`,
    {
  ...
  const rdsLowMemoryAlarm = new aws.cloudwatch.MetricAlarm(
    `${baseName}-rds-low-memory`,
    {
  ...
  const rdsHighReadLatencyAlarm = new aws.cloudwatch.MetricAlarm(
    `${baseName}-rds-high-read-latency`,
    {
  ...
  const rdsHighWriteLatencyAlarm = new aws.cloudwatch.MetricAlarm(
    `${baseName}-rds-high-write-latency`,
    {
  ...
  const rdsLowStorageAlarm = new aws.cloudwatch.MetricAlarm(
    `${baseName}-rds-low-storage`,
    {
  ...
  const sqsOfflineDlqAlarm = new aws.cloudwatch.MetricAlarm(
    `${baseName}-sqs-offline-dlq`,
    {
  ...
  const sqsOldMessageAlarm = new aws.cloudwatch.MetricAlarm(
    `${baseName}-sqs-old-message`,
    {
  ...
  const realtimeUnhealthyTargetsAlarm = new aws.cloudwatch.MetricAlarm(
    `${baseName}-realtime-unhealthy`,
    {
  ...
  const apiUnhealthyTargetsAlarm = new aws.cloudwatch.MetricAlarm(
    `${baseName}-api-unhealthy`,
    {
